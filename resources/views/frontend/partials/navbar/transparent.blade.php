<nav class="navbar navbar-default navbar-transparent navbar-fixed-top navbar-color-on-scroll" color-on-scroll=" " id="sectionsNav">
    	<div class="container">
        	...
        	<div class="navbar-header">
        		...
        		<a class="navbar-brand" href="{{url('/')}}">Base 2018</a>
        	</div>
        	...
        	<div class="collapse navbar-collapse">
        		<ul class="nav navbar-nav navbar-right">
					...
					<li class="button-container">
						<a href="{{url('/login  ')}}" target="_blank" class="btn btn-rose btn-round">
							<i class="material-icons">account_box</i> Ingresar
						</a>
					</li>
        		</ul>
        	</div>
	...
	<div class="page-header header-filter clear-filter" data-parallax="true" style="background-image: url('{{asset('img/bg0.jpg')}}');">
		<div class="container">
			<div class="row">
